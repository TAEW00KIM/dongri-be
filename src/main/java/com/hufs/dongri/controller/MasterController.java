...
public class MasterController {
    ...
    public ApiResult<List<ApplicationDto>> getPendingApplications() {
        List<ApplicationDto> data = masterService.getPendingApplications();
        return ApiResult.success(HttpStatus.OK.value(), "학생 승급 신청 목록 조회 성공", data);
    }
    ...
    public ApiResult<Void> rejectApplication(
        ...
        return ApiResult.success(HttpStatus.OK.value(), "학생 승급 신청을 거절했습니다.");
    }
    ...
    public ApiResult<List<PendingUserDto>> getPendingAccounts() {
        List<PendingUserDto> data = masterService.getPendingAccounts();
        return ApiResult.success(HttpStatus.OK.value(), "공용 계정 승인 대기 목록 조회 성공", data);
    }
    ...
    public ApiResult<Void> approveClubAccount(
        ...
        return ApiResult.success(HttpStatus.OK.value(), "계정 승인 및 운영진 임명 완료");
    }
}